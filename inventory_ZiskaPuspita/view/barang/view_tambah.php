        ...
        <div class="container">
            ...
            <form action="proses_tambah.php" mehod="post">
                <div class="mb-3">
                    ...
                    <input type="text" class="fprm-control" name="id_barang" id="exampleInputEmail"
                    aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
                <label for="exampleInputEmail" class="form-label">nama</label>
                    <input type="text" class="fprm-control" name="nama" id="exampleInputPassword">
                    
                </div>
                <div class="mb-3">
                <label for="exampleInputEmail" class="form-label">harga</label>
                    <input type="text" class="fprm-control" name="harga" id="exampleInputEmail">
                    
                </div>
                <div class="mb-3">
                <label for="exampleInputEmail" class="form-label">ID jenis</label>
                    <input type="text" class="fprm-control" name="id_jenis" id="exampleInputEmail">
